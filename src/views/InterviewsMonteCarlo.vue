    ...
    <div class="">
      <div class="d-flex justify-content-center">
        <form class="col-4">
          ...
          <div class="form-group">
            <label for="percentage">Percentage of Participants to be Interviewed for a Highest Score</label>
            <input v-model="percentage" type="number" step="0.01" class="form-control" id="percentage" placeholder="Enter Percentage in %">
          </div>
        </form>
      </div>
