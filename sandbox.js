function interviews(nApplicants, perc) {
  ...
  if (hiredApplicant.length !== 0) {
    ...
    if (hiredApplicant[0] == sortedApplicants[0][0]) {
      ...
      output.push(`Unfortunately, the best applicant is yet to come. He is applicant no:${sortedApplicants[0][0]} with a score of ${sortedApplicants[0][1]}`, `You failed to hire the best applicant`, `You had only one job!`);
    }
  } else {
...
console.log(interviews(100, 0.33));
